...
SUBSCRIBE_REQUIRED_CHANNEL_LIST = [
    {
        "name": "Mars Airdrops",
        "id": -1001739364923,
        "invite_link": "https://t.me/mars1airdrop" 
    }
]  # If you have no idea what needs to be entered here, read the documentation

DEFAULT_DAILY_GAME_KEYS_LIMIT = 4
DEFAULT_USER_MULTIPLIER = 1.0
DEFAULT_NUM_KEYS_PER_REQUEST = 4

# YOU MUST KEEP THIS LINK OR OTHER MENTION OF AUTHORSHIP IN ORDER TO PRESERVE THE LICENSE
PROJECT_PDOSI_INVITE_URL = "https://t.me/mars4955"
